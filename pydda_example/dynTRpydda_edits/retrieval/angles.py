...
RSL_get_slantr_and_elev, written by John Merritt and Dennis Flanigan
    ...
    #Rounding criteria added
    #print("This is gr", gr)
    #print("This is h", h)
    #print("This is type gr", type(gr))
    #print("This is type h", type(h))
    elev = np.arccos(np.clip((Re**2 + slantrsq - rh**2)/(2 * Re * slantr),-1.0,1.0))
...
def add_elevation_as_field(grid, dz_name='DT', el_name='EL', bad=-32768):
    ...
    *not* AGL. Ground range computed using the Haversine method.
    ...
    #print("This is the error", rsl_get_slantr_and_elev(gr[1][60][60], h3[1][60][60]))
